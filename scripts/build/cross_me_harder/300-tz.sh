...
do_cross_me_harder_tz_build() {
    ...
    CT_DoExecLog ALL make ${JOBSFLAGS} all TOPDIR=/usr TZDIR=/usr/share/zoneinfo ETCDIR=/usr/sbin MANDIR=/usr/share/man cc=gcc
    ...
    CT_DoExecLog ALL make ${JOBSFLAGS} all TOPDIR=/usr TZDIR=/usr/share/zoneinfo ETCDIR=/usr/sbin MANDIR=/usr/share/man cc=${CT_TARGET}-gcc CFLAGS="-g -Os"
