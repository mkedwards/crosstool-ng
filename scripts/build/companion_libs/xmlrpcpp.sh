...
do_xmlrpcpp_get() {
    CT_GetFile "xmlrpcpp-${CT_XMLRPCPP_VERSION}" .tar.gz    \
               "http://mesh.dl.sourceforge.net/sourceforge/xmlrpcpp/xmlrpc++/Version ${CT_XMLRPCPP_VERSION}"
    # Downloading from sourceforge may leave garbage, cleanup
    CT_DoExecLog ALL rm -f "${CT_TARBALLS_DIR}/showfiles.php"*
}

do_xmlrpcpp_extract() {
    CT_Extract "xmlrpcpp-${CT_XMLRPCPP_VERSION}"
