...
TARGET_ME_HARDER_CONFIG_FILES = $(patsubst $(CT_LIB_DIR)/%,%,$(wildcard $(CT_LIB_DIR)/config/target_me_harder/*.in))
...
GEN_CONFIG_FILES = config.gen/arch.in     \
                   ...
                   config.gen/cc.in       \
                   config.gen/libc.in     \
                   config.gen/target_me_harder.in \
...
TARGET_ME_HARDERS = $(patsubst config/target_me_harder/%.in,%,$(TARGET_ME_HARDER_CONFIG_FILES))
...
config.gen/target_me_harder.in: $(TARGET_ME_HARDER_CONFIG_FILES)
	$(call build_gen_menu_in,$@,Target_me_harder,TARGET_ME_HARDER,config/target_me_harder,$(TARGET_ME_HARDERS))
